    ...
    <>
      <Form onSubmit={handleSubmit}>
        ...
        <Form.Group className="mb-3">
          ...
          <Form.Control
            name="players" // Changed from "numberOfPlayers" to "players"
            value={currentGame.players} // Changed from "numberOfPlayers" to "players"
            onChange={handleChange}
            required
          />
          ...
          <Form.Control
            name="skill level" // Changed from "skillLevel" to "skill level"
            value={currentGame['skill level']} // Changed from "skillLevel" to "skill level"
            onChange={handleChange}
            required
          />
        </Form.Group>
