...
export default function Game() {
  ...
  useEffect(() => {
    console.warn('id', id); // Check if the id is defined
    if (id) {
      console.warn('Calling getGame with id:', id); // Check if the getGame function is being called
      getGame(id)
        .then((gameData) => {
          console.warn(gameData); // Check if the getGame function is returning the expected data
          setGame(gameData);
        })
        .catch((error) => {
